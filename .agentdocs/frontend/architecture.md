...
- `css/homepage.css`：首页商业转化改版专属样式，负责首页首屏、采购证据、产品入口、订单流程、创意动效与最终 CTA。
...
- 首页当前采用转化型落地页结构：价值主张、产品视觉、报价简报入口、采购证据、产品入口、订单流程与最终 CTA 依次推进；首页专属样式与纸张纹理、产品浮动、按钮高光、卡片工艺线、图片扫光、流程连线等动效应优先放在 `css/homepage.css`。
